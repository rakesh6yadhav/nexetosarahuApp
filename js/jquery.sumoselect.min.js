...
! function(e) {
    ...
    e.fn.SumoSelect = function(t) {
        var l = e.extend({
                placeholder: "Choose Management List",
                csvDispCount: 3,
            ...
            s = this.each(function() {
                ...
                !this.sumo && e(this).is("select") && (this.sumo = {
                    ...
                    toggSelAll: function(t, l) {
                        var i = this;
                        i.optDiv.find("li.opt:not(.hidden,.disabled)").each(function(l, i) {
                            var i = e(i),
